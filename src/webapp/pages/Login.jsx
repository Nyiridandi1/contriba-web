        ...
        <div className="million-hero">
          ...
          <div className="million-hero-inner">
            <div className="million-mobile-hero-topbar">
              <Link
                to="/"
                className="million-mobile-brand"
              >
            ...
            <div className="million-hero-content">
              ...
              <p>
                Create events, track contributors,
                monitor your wallet and understand
                your fundraising performance with
                confidence.
              </p>
            ...
            <div
              className="million-dashboard-preview"
              aria-hidden="true"
            >
              <div className="million-preview-top">
                ...
                <span className="million-status-dot">
                  Live
                </span>
              </div>
              ...
              <div className="million-preview-grid">
                <div className="million-preview-card">
                  ...
                  <span className="million-positive">
                    +18.4%
                  </span>
                </div>
        ...
        <div className="million-panel">
          <div className="million-panel-inner">
            <div className="million-login-card">
              {accountCreated && (
                <div
                  className="million-account-success"
                  role="status"
                  aria-live="polite"
                >
